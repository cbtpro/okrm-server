...
public interface IUserService {
     ...
     * @return 更新后的用户信息
     */
    UserInfo updateUserInfo(String uuid, String avatar, String username, String nickname, String province, String city,
            String county, Timestamp birthday);
     ...
     * @return
     */
    List<Address> getUserNearbyUserAddress(String uuid, Double longitude0, Double latitude0, Double longitude1,
