...
public interface UserInfoRepository extends JpaRepository<UserInfo, String> {
    ...
    int updateUserInfo(String uuid, String avatar, String username, String nickname, String province, String city,
    ...
    List<Address> queryUserNearbyUserAddress(Double minLongitude, Double maxLongitude, Double minLatitude,
            Double maxLatitude);
