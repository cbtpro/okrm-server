...
public class TaskControllerTest {
	...
	public void whenCreateTaskSuccess() throws UnsupportedEncodingException, Exception {
		...
		String result = mockMvc
				.perform(MockMvcRequestBuilders.post("/task").contentType(MediaType.APPLICATION_JSON_VALUE)
						.content(content))
	...
	public void whenQueryTaskSuccess() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/task/ff9c7f59-3652-4510-bd0b-1d57d2fd3917").contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(MockMvcResultMatchers.status().isOk())
	...
	public void whenQueryTasksSuccess() throws Exception {
		mockMvc.perform(
				MockMvcRequestBuilders.get("/tasks").param("title", "弹钢琴").contentType(MediaType.APPLICATION_JSON_VALUE))
				.andExpect(MockMvcResultMatchers.status().isOk())
